...
max_steering_angle = pi / 4.0  # Limitations of a real car.
...
class robot:
    ...
    def measurement_prob(self, measurements):
        ...
        predicted_measurements = self.sense(1)  # Our sense function took 0 as an argument to switch off noise.
...
####Derivation of these equations: https://classroom.udacity.com/courses/cs373/lessons/48726342/concepts/486955210923  ####
